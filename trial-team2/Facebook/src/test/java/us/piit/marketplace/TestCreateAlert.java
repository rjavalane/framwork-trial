...
public class TestCreateAlert extends CommonAPI {
    @Test
    public void testCreateAlert() {
        ...
        marketPlacePage.typeOnPriceMinField();
        marketPlacePage.typeOnPriceMaxField();
        Assert.assertTrue(marketPlacePage.createAlertBtn.isEnabled());
        marketPlacePage.clickOnCreateAlert();
