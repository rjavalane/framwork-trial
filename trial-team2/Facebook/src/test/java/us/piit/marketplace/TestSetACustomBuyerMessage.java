...
public class TestSetACustomBuyerMessage extends CommonAPI {
    @Test
    public void TestRemoveItemsFromCart(){
        ...
        marketPlacePage.clickOnSettingIcon();
        marketPlacePage.clickOnSetMessage();
        marketPlacePage.typeMessageCustomBuyer();
        marketPlacePage.clickOnSaveButton();
